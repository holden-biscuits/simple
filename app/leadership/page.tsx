    ...
    <main id="page-top">
      ...
      <section className="shell leadership-decisions" id="leadership-decisions">
        ...
        <div className="leadership-risk-grid">
          ...
          <article><span>04 · CRM coverage</span><h3>Only {brief.outcomes.representedEvents} event has exact deal attribution.</h3><p>The canonical Event key and Marketing Event objects are still missing from most CRM records, so portfolio pipeline is not yet a trustworthy leadership metric.</p><Link href="/sources#crm-attribution">Open CRM audit →</Link></article>
        </div>
        <BackToTop />
      </section>
