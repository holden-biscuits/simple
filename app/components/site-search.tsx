...
const quickSearches = [
  ...
  { label: "Pending source fixes", query: "upstream correction" },
...
const searchAliases: Record<string, string[]> = {
  ...
  passes: ["passes", "pass", "credentials", "tickets", "seats"],
  pass: ["pass", "passes", "credentials", "tickets", "seats"],
  unassigned: ["unassigned", "open", "missing", "staffing", "roster"],
  ...
  need: ["need", "needs", "needed", "open", "attention", "incomplete", "task", "action"],
  ...
  result: ["result", "results", "outcome", "outcomes", "meetings", "demos", "deals"],
  happened: ["happened", "result", "results", "outcome", "outcomes", "closeout"],
  outcome: ["outcome", "outcomes", "result", "results", "closeout"],
  outcomes: ["outcomes", "outcome", "result", "results", "closeout"],
  target: ["target", "targeting", "prospecting", "audience", "accounts", "contacts"],
  targeting: ["targeting", "target", "prospecting", "audience", "accounts", "contacts"],
