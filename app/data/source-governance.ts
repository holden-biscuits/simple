...
export const writebackQueue: WritebackItem[] = [
  ...
  },
  {
    ...
    proposed: "Add the four-person roster decision, Aug 11 onboarding call at 9:30 AM PT, portal-profile work, website ticket link, the organizer clarification that insurance is recommended but not mandatory, and the open pipe-and-drape, booth-number and payment questions with owners and due dates",
    evidence: "Organizer onboarding email, rescheduled calendar invitation and insurance clarification · Aug 7",
