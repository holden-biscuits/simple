...
export const eventFieldRoutes: EventFieldRoute[] = [
  ...
  ...["meetingsBooked", "followupMeetingsBooked", "meetingCountLabel", "demosBooked", "closed", "outcomeNotes", "crmSnapshot"].map((field) => ({ field, owner: "hubspot" as const, destination: "HubSpot" })),
...
export const writebackQueue: WritebackItem[] = [
  ...
  },
  {
    ...
    eventSlug: "ccw-exchange-chicago",
    current: "No exact Chicago meeting records are available to the fieldbook audit",
  ...
  },
  {
    ...
    evidence: "Fieldbook CRM operating rule · Aug 6",
  ...
  },
  {
    ...
    eventSlug: "customer-connect-expo",
    current: "Notion project blank · fieldbook priority says Aug 10 at 9:00 AM PT and treats insurance as an open requirement",
    proposed: "Set the priority to Aug 11 at 9:30 AM PT; keep the booth-logistics questions and state that insurance is recommended, not mandatory",
    evidence: "Scheduled scan proposal customer-connect-priority-actions-20260807-0900 · Aug 7",
    evidenceUrl: "https://mail.google.com/mail/#all/19fdc431223bee42",
    state: "Ready for approval",
  ...
  },
  {
    ...
    eventSlug: "customer-connect-expo",
    current: "Notion project blank · fieldbook task is due Aug 10 at 9:00 AM PT and asks for proof-of-insurance requirements",
    proposed: "Set the task due date to Aug 11 at 9:30 AM PT and replace the insurance question with the organizer’s recommended-but-not-mandatory guidance",
    evidence: "Scheduled scan proposal customer-connect-marketing-tasks-20260807-0900 · Aug 7",
    evidenceUrl: "https://mail.google.com/mail/#all/19fdc431223bee42",
    state: "Ready for approval",
    url: "https://www.notion.so/3b46fee642fe80dc9ff9d1ae2661aa2c",
  },
  {
    ...
    eventSlug: "customer-connect-expo",
    current: "Notion project blank · fieldbook workstream says Aug 10 at 9:00 AM PT and leaves insurance requirements open",
    proposed: "Set the workstream call to Aug 11 at 9:30 AM PT and record that insurance is recommended, not mandatory",
    evidence: "Scheduled scan proposal customer-connect-workstreams-20260807-0900 · Aug 7",
    evidenceUrl: "https://mail.google.com/mail/#all/19fdc431223bee42",
    state: "Ready for approval",
    url: "https://www.notion.so/3b46fee642fe80dc9ff9d1ae2661aa2c",
  },
