...
export const events: EventRecord[] = [
  ...
  },
  {
    ...
    team: [],
    available: [],
    notes: "Confirmed. Four attendees and a 10×10 booth are planned; attendee names and the remaining booth details are still open.",
    rating: "None",
    meetingsBooked: [],
    demosBooked: [],
    closed: [],
    ...
    priorityActions: [
      ...
      "Assign owners for booth coverage, lead capture, travel, and post-event follow-up.",
    ],
    workstreams: {
      speaking: ["None"],
      sponsorship: ["10×10 booth", "Confirm the contract inclusions, booth number, exhibitor deadlines, lead retrieval, power, furniture, signage, and shipping"],
