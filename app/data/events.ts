...
export const events: EventRecord[] = [
  ...
  },
  {
    ...
    team: [],
    available: [],
    notes: "Confirmed with an executed exhibition-space contract. Four attendees and a 10×10 booth are planned; attendee names and the booth number are still open. Portal registration is complete; the exhibitor profile was 25% complete on Aug 6.",
    rating: "None",
    meetingsBooked: [],
    demosBooked: [],
    closed: [],
