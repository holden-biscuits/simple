...
export const events: EventRecord[] = [
  ...
  },
  {
    ...
    workstreams: {
      ...
      secondary: ["None"],
      travel: ["Wynn Las Vegas", "Attending: Cat, Holden, Matt, Taylor, Josh, Carter, Deepti, Richard, and Lars", "Publish registration, travel, and booth-shift details for all nine attendees"],
