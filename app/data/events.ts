...
export const events: EventRecord[] = [
  ...
  },
  {
    ...
    team: ["Zach", "Taylor"],
    available: [],
    notes: "The tracker reports 10–15 meetings, many unqualified, and five named demos. Matt and Josh were marked out.",
    rating: "None",
    meetingsBooked: [],
  ...
  },
  {
    ...
    workstreams: {
      ...
      travel: ["Taylor and Josh attending", "Verify return travel and registration only if unresolved"],
  ...
  },
  {
    ...
    team: [],
    available: ["Carter"],
    notes: "The tracker still shows TBD with five attendees modeled and only Carter marked available. There is no active Notion project yet.",
    rating: "None",
    meetingsBooked: [],
    demosBooked: [],
    closed: [],
    ...
    priorityActions: [
      "Make the go/no-go decision and name the owner.",
      "Review the prospectus and decide whether a speaking or sponsor package is worth pursuing.",
      "If attending, assign the five-person roster and book travel; Carter is the only person marked available in the tracker.",
      "If attending, build an account list for inbound-call, pay-per-call, lead-response, and contact-center operators before outreach starts.",
    ],
    workstreams: {
      speaking: ["Prospectus available; no slot confirmed", "Decide whether to pursue a slot as part of go/no-go"],
      sponsorship: ["None confirmed"],
      meetings: ["No guaranteed meetings", "If approved, build a target list and pre-book directly"],
      swag: ["None until participation is approved"],
      secondary: ["None"],
      travel: ["Five attendees modeled; Carter is marked available", "Do not book until go/no-go and roster approval"],
      marketing: ["None until participation is approved"],
      followup: ["Standard follow-up only if the event proceeds"],
      budget: ["Compare the prospectus cost and total travel against the expected account opportunity"],
    },
  },
  {
    ...
    sponsorship: "Booth + Wish Line OOH proposal pending approval",
    guaranteedMeetings: "No",
    attendeeCount: 9,
    team: ["Cat", "Matt", "Taylor", "Josh"],
    available: ["Carter"],
    ...
    priorityActions: [
      ...
      "Finalize the nine-person roster and publish booth shifts, talk coverage, meetings, and breaks.",
      "Lock the talk title, room, speaker, deck, and rehearsal; the session is Sep 3 at 1:10 PM.",
      "Launch the event email and usesimple.ai/xperience page with HubSpot campaign tracking and a 15-minute booth-demo CTA.",
    ],
    relatedLinks: [
    ...
    workstreams: {
      ...
      sponsorship: ["Booth in Orchestrators Hall", "Wish Line OOH proposal: $15K Firefly flight Aug 31–Sep 3; approval and IO terms still open", "If approved, assign the daily review team, fulfillment owner, consent guardrails, and booth handoff"],
      ...
      marketing: ["Pre-event email: voice AI in Orchestrators Hall with the Omaha Steaks proof point", "usesimple.ai/xperience landing page with a 15-minute booth-demo CTA", "Tag form submissions to the Genesys Xperience 2026 HubSpot campaign", "If Wish Line proceeds, deliver media creative by Aug 20 and prepare the Sep 3 social/recap handoff"],
  ...
  },
  {
    ...
    team: ["Taylor"],
    available: ["Carter"],
    notes: "This starts five days after Genesys. The same team cannot treat Vegas, London production, and travel as separate plans.",
    rating: "None",
    meetingsBooked: [],
    demosBooked: [],
    closed: [],
    ...
    priorityActions: [
      ...
      "Confirm the speaker and title, then build the plenary around externally safe travel/hospitality proof points.",
      "Select a London printer for leave-behinds instead of shipping materials through customs.",
    ],
    workstreams: {
      speaking: ["30-minute plenary", "Confirm speaker and title/abstract with IQPC", "Use the published Omaha numbers as the externally safe proof points", "Build deck, complete the Pre-Publish Gate, rehearse, and confirm AV"],
      sponsorship: ["None"],
      meetings: ["Guaranteed meetings; count and format not yet confirmed", "Get the matched-account list and prepare one brief per meeting", "Log meetings and demos in Monaco"],
  ...
  },
  {
    ...
    status: "TBD",
    speaking: "None",
    sponsorship: "10×10 booth in Notion; tracker needs reconciliation",
    guaranteedMeetings: "No",
    attendeeCount: 4,
    team: [],
    available: [],
    notes: "Source conflict: the tracker has no status or headcount, while the Aug 6 Notion record says confirmed, four attendees, and a 10×10 booth. Keep this TBD until the tracker is reconciled.",
    rating: "None",
    meetingsBooked: [],
    demosBooked: [],
    closed: [],
    ...
    priorityActions: [
      "Reconcile the tracker with Notion: status, four-person headcount, 10×10 booth, and SDR roster.",
      "Find the contract or sponsor confirmation and record booth number, inclusions, exhibitor deadlines, lead retrieval, power, furniture, and shipping instructions.",
      "Name the four attendees. Notion currently says only “SDRs TBD.”",
      "Do not launch promotion or book travel until status and ownership are resolved.",
    ],
    workstreams: {
      speaking: ["None"],
      sponsorship: ["10×10 booth appears in Notion; confirm against the contract and tracker", "Record booth number, exhibitor deadlines, lead retrieval, power, furniture, signage, and shipping"],
      meetings: ["No guaranteed meetings", "If confirmed, use the event app and exhibitor list to build a target list and pre-book"],
      swag: ["None planned"],
      secondary: ["None"],
      travel: ["Four attendees appear in Notion; roster is “SDRs TBD”", "Do not book until the tracker is reconciled"],
      marketing: ["None until status, booth deliverables, and owner are confirmed"],
      followup: ["If attending, capture booth context in HubSpot and assign one owner per follow-up"],
      budget: ["Locate the booth contract and reconcile total sponsor, travel, and production cost"],
    },
  },
  {
  ...
  },
  {
    ...
    team: [],
    available: ["Matt", "Taylor", "Carter", "Josh"],
    notes: "Source conflict: the tracker says tentative, while the Notion property says confirmed but the page itself still calls for a go/no-go. Keep this tentative until the decision is recorded consistently.",
    rating: "None",
    meetingsBooked: [], demosBooked: [], closed: [],
    ...
    priorityActions: [
      "Make and record the go/no-go decision by the end of September.",
      "Reconcile the tracker and Notion status; release the calendar hold if the answer is no.",
      "Confirm whether the Wednesday Lunch & Learn is contracted or still part of sponsor negotiation.",
      "If proceeding, compare audience fit, total cost, and expected meetings before selecting a booth or sponsor package.",
    ],
    relatedLinks: [
    ...
    workstreams: {
      ...
      followup: ["Standard follow-up only if the event proceeds"],
      budget: ["Validate audience fit, total sponsor cost, and expected meeting value before approval"],
    },
  },
  {
