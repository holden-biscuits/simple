...
const referenceRecords: SearchRecord[] = [
  ...
  { type: "Operations", title: "Daily event action briefing", href: "/sources#action-briefing", description: "The private Slack briefing that asks for decisions, overdue-task updates, exact write-back approvals, and time-sensitive source blockers only when action is required.", keywords: "daily briefing slack dm ping me reminder update request open items action needed decision approval overdue task source blocker reply automation 9 am email digest" },
