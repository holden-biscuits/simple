...
const referenceRecords: SearchRecord[] = [
  ...
  { type: "Guide", title: "Event operating loop", href: "/#event-lifecycle", description: "Move from participation decision through planning, promotion, preparation, onsite execution, follow-up, and measurement using the right workspace at each stage.", keywords: "event lifecycle workflow what do I do next after event decide approve plan promote prepare onsite run follow up close measure tracker notion marketing AE SDR HubSpot leadership" },
