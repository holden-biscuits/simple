...
const referenceRecords: SearchRecord[] = [
  ...
  { type: "Operations", title: "Leadership event program brief", href: "/leadership", description: "Portfolio commitments, execution readiness, next decisions, and CRM-proven outcomes.", keywords: "executive leadership portfolio event program commitments readiness risks decisions outcomes ROI pipeline" },
