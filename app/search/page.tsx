...
const referenceRecords: SearchRecord[] = [
  ...
  { type: "Operations", title: "Event-sourced pipeline", href: "/marketing#event-pipeline", description: "HubSpot opportunity count, stage distribution, open pipeline, closed-won revenue, and amount hygiene for event-sourced deals.", keywords: "hubspot event conference trade show field dinner opportunities deals stages open pipeline revenue closed won deal source amount" },
